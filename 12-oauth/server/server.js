...
const server = http.createServer((req, res) => {
  ...
  if (req.method === 'GET') {
    ...
    // Upon successful user authorization, a GET request will be sent from the authorization
    // server to "/oauth/code" along with an authorization code. In response, we will POST
    // that code along with our client id and client secret to the authorization server in
    // exchange for an access token. That token will be returned to the client in the form
    // of a cookie.
    //
