...
function setupQuoteDOM() {
  ...
  // Create the "Logout" button. When clicked, this button will log the user out by
  // forcibly expiring the document cookie created when we logged in.
  //
...
// return false.
//
// Note that in a more realistic app, we would probably do more to verify the token
// for authenticity. In this simple sample, it's enough that the token exists.
//
function loggedIn() {
